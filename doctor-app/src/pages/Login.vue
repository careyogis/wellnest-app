...
const sendOtpResource = createResource({ url: 'wellnest.api.auth.send_practitioner_otp' });
const verifyOtpResource = createResource({ url: 'wellnest.api.auth.verify_practitioner_otp_and_login' });
